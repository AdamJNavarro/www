						...
						{navbarRoutes.map((item) => {
							...
							return (
								<Link
									...
									href={item.href}
									className={classNames({
										"relative flex items-center py-6 px-2 tablet:px-4 rounded-md font-medium text-md": true,
										"text-slate-700 dark:text-slate-200 hover:text-slate-950 dark:hover:text-white": true,
