	...
	return (
		<div>
			...
			<div className="prose mb-24">
				<p>
					I wouldn't classify myself as a cinephile but I'd say I am teetering
					right on the edge. Going to the theater is a weekly ritual and it
					isn't often that I miss a week. As a result, sometimes you end up
					seeing some less-than-stellar films but there is simply something
					magical about the cinema for me. The popcorn. The sound. The
					immersion.
				</p>
			</div>
			...
			<div className="mb-24">
				...
				<div className="text-sm text-surface-tertiary text-center mt-4">
					Updated{" "}
					{formatDate({ date: letterboxdData.updatedAt, format: "ago" })}
				</div>
			</div>
			...
			<div className="prose mb-24">
				<p>
					As you can see, Peter Jackson's Lord of the Rings trilogy holds a
					special place in my heart. Frank Darabont's Shawshank is another film
					that left an indelible mark on me. Letterboxd only allows for a Top 4
					but I'll be creating a custom list and adding more entries in the
					future.
				</p>
			</div>
