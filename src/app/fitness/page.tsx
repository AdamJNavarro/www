    ...
    <div>
      ...
      <div className="prose mb-24">
        <p>
          ...
          was spent either playing neighborhood games (think Kick the Can, Ghost in
          the Graveyard, etc.) or jumping on a trampoline. When I got to highschool,
          I became enamored with the weight room and shortly thereafter found my way
          onto the wrestling team. Four years of wrestling and the accompanying team
          gym sessions instilled a love for lifting weights that has been going
          strong for a decade plus.
        </p>
      </div>
