	...
	return (
		<div>
			...
			<div className="prose mb-24">
				<p>
					I try to limit myself to no more than two books at a time. In order to
					keep things fresh, I make an effort to rotate between non-fiction and
					fiction. Typically I am apprehensive towards longer series and
					gravitate towards standalone books but if I hear enough good things, I
			...
			<div className="prose mb-24">
				<p>
					Here are the last 10 books I’ve finished. To see all of my past
					reading (since I started logging), you can check out my{" "}
					<a
					...
					. If you have any questions or want to discuss any of the titles, feel
					free to <Link href={routes.social.href}>reach out</Link>.
